          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
                ...
                established company looking to modernize your digital presence,
                Bitloom is here to help. We specialize in turning complex
                business requirements into elegant, scalable solutions through
                transparent communication and remote-first collaboration.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://twitter.com/bitloom"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === "success" && (
                <div className="p-4 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded-lg">
                  Thank you for your business inquiry! We&apos;ll review your
                  project details and get back to you within 24 hours to discuss
                  next steps.
                </div>
              )}
              ...
              {submitStatus === "error" && (
                <div className="p-4 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 rounded-lg">
                  Sorry, there was an error sending your inquiry. Please try
                  again or contact us directly at info@bitloom.sk.
                </div>
              )}
            </form>
          </div>
