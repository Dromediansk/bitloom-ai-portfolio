...
export const ProjectCard = memo(({ project }: ProjectCardProps) => {
  return (
    <article className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-all duration-300 will-change-transform group hover:shadow-xl hover:-translate-y-1 border border-gray-100 dark:border-gray-700 hover:border-primary-200 dark:hover:border-primary-700">
      {/* Project Image */}
