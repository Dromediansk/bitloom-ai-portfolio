      ...
      >
        ...
        <div className="flex space-x-4">
          <a
            ...
            className={`w-10 h-10 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center hover:bg-gray-300 dark:hover:bg-gray-600 transition-all duration-300 hover:scale-110 hover:shadow-lg ${
              hasIntersected ? "opacity-100 scale-100" : "opacity-0 scale-75"
            }`}
            style={{ transitionDelay: hasIntersected ? "900ms" : "0ms" }}
          >
            <svg
